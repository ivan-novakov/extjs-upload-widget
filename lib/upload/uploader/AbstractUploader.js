...
Ext.define('Ext.ux.upload.uploader.AbstractUploader', {
    ...
    config : {
        ...
        /**
         * @cfg {String} [filenameEncoderHeader='X-Filename-Encoder']
         * 
         * The name of the HTTP header carrying information about the encoder used to encode
         * the filename.
         */
        filenameEncoderHeader : 'X-Filename-Encoder',
        
        /**
         * @cfg {String} [maxFileSizeErrorText='File too big']
         * 
         * The error message shown, when the maxFileSize has been exceeded.
         */
    ...
    /**
     * @protected
     * @param {Ext.ux.upload.Item}
     * @return {null/File}
     */
    prepareFileApiObject : function(item) {
        if (item.getSize() > this.getMaxFileSize()) {
            var info = {
                success : false,
                message : this.getMaxFileSizeErrorText(),
                response : null
            };
